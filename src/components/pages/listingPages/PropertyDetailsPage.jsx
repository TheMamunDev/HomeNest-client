...
const PropertyDetailsPage = () => {
  ...
  return (
    <div className="py-12 bg-base-200">
      <div
        className=" mx-auto px-4 max-w-11/12 xl:max-w-7xl "
        data-aos="fade-in"
      >
        <div className="bg-base-100 rounded-xl shadow-2xl overflow-hidden mb-8 border border-gray-200">
          <figure className="w-full h-[300px] md:h-[450px] lg:h-[500px] xl:h-[550px] relative">
            <img
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div
            className="lg:col-span-1 bg-base-100 p-6 rounded-xl shadow-lg border border-gray-200 h-fit"
            data-aos="fade-up"
          >
