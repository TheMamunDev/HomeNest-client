    ...
    <footer className=" py-10 navbar-card-bg ">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mx-auto max-w-11/12 gap-6">
        ...
        <nav className="w-full text-secondary ">
          ...
          <p className="link link-hover opacity-70">Email: info@homenest.com</p>
          <p className="link link-hover opacity-70">Phone: +1 (555) 123-4567</p>
        ...
        <nav className="w-full text-secondary">
          ...
          <Link to="/terms" className="link link-hover opacity-70">
            Terms of use
          </Link>
          <Link to="/privacy" className="link link-hover opacity-70">
            Privacy policy
          </Link>
          <Link to="/cookie-policy" className="link link-hover opacity-70">
            Cookie policy
          </Link>
        </nav>
